...
class Search():
    ...
    _feedback = planner_urc.msg.SearchTagFeedback()
    _result = planner_urc.msg.SearchTagResult()
    ...
    def __init__(self, name):
        ...
        self._as = actionlib.SimpleActionServer(self._action_name, planner_urc.msg.SearchTagAction, execute_cb=self.execute_cb, auto_start = False)
        self._as.start()
