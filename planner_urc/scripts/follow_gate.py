...
class Follow():
    ...
    _feedback = planner_urc.msg.FollowGateFeedback()
    _result = planner_urc.msg.FollowGateResult()
   ...
   # image data
    ...
    def __init__(self, name):
        ...
        self._as = actionlib.SimpleActionServer(self._action_name, planner_urc.msg.FollowGateAction, execute_cb=self.execute_cb, auto_start = False)
        self._as.start()
    ...
    def execute_cb(self,goal):
        ...
        while (self.cnt < self.cnt_threshold) and not rospy.is_shutdown():
        ...
        if self.cnt >= self.cnt_threshold:
